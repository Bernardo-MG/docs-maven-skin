...
assert metaOgSite.attr( 'content' ).equals( 'Metadata minimal page – metadata-minimal-site' )
assert metaOgTitle.attr( 'content' ).equals( 'Metadata minimal page – metadata-minimal-site' )
...
assert metaTwTitle.attr( 'content' ).equals( 'Metadata minimal page – metadata-minimal-site' )
