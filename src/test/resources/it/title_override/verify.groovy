...
assert metaOgSite.attr('content') == 'Title override – Overriden'
assert metaOgTitle.attr('content') == 'Title override – Overriden'

// Verifies the Twitter metadata is generated
def metaTwTitle = head.select('meta[name="twitter:title"]')
assert metaTwTitle.attr('content') == 'Title override – Overriden'
