...
assert link.html().contains('SCM <span class="note">GitHub</span>')
...
assert link.html().contains('CI <span class="note">Github workflow<</span>')
assert link.hasClass( 'link-noted' )
...
assert link.html().contains('Issues <span class="note">GitHub</span>')
assert link.hasClass( 'link-noted' )
