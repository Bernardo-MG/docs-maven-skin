...
assert html.contains( '<meta property="og:site" content="Complete site example &#x2013; library-maven-archetype-example"/>' )
assert html.contains( '<meta property="og:title" content="Complete site example &#x2013; library-maven-archetype-example"/>' )
...
assert html.contains( '<meta name="twitter:title" content="Complete site example &#x2013; library-maven-archetype-example"/>' )
